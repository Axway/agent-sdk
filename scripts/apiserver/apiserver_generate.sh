...
if node ./generate.js ${PROTOCOL} ${HOST} ${PORT}; then
  ...
  cp ./model_credential_request_definition_spec_capabilities.tmpl ${OUTDIR}/models/catalog/v1alpha1/model_credential_request_definition_spec_capabilities.go
  cp ./model_credential_request_definition_spec_provision.tmpl ${OUTDIR}/models/catalog/v1alpha1/model_credential_request_definition_spec_provision.go
  cp ./model_credential_request_definition_spec_webhook.tmpl ${OUTDIR}/models/catalog/v1alpha1/model_credential_request_definition_spec_webhook.go
  cp ./model_credential_request_definition_spec.tmpl ${OUTDIR}/models/catalog/v1alpha1/model_credential_request_definition_spec.go
