...
var regionalSettingsMap = map[Region]regionalSettings{
	US: {
		...
		TraceabilityHost:     "https://ingestion.datasearch.axway.com:443",
		TraceabilityProtocol: "",
		Deployment:           "prod",
	},
	EU: {
		...
		AuthURL:              "https://login.axway.com/auth",
		PlatformURL:          "https://platform.axway.com",
		TraceabilityHost:     "https://ingestion.visibility.eu-fr.axway.com:443",
		TraceabilityProtocol: "",
		Deployment:           "prod-eu",
	},
	AP: {
		...
		AuthURL:              "https://login.axway.com/auth",
		PlatformURL:          "https://platform.axway.com",
		TraceabilityHost:     "https://ingestion.visibility.ap-sg.axway.com:443",
		TraceabilityProtocol: "",
		Deployment:           "prod-ap",
	},
	EU2: {
		...
		TraceabilityHost:     "https://phoenix.eu-fr.axway.com:443",
