...
func TestRootCmdFlags(t *testing.T) {
	...
	assertStringCmdFlag(t, rootCmd, "central.apiServerEnvironment", "apiServerEnvironment", "", "The Environment that the APIs will be associated with in AMPLIFY Central")
