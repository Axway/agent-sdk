...
func setupDeleteValidator(deleteServiceValidation bool) {
	agent.deleteServiceValidator = func(apiID, stageName string) bool {
		return deleteServiceValidation
	}
}
