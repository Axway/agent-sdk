...
var (
	...
	ErrFilterExpression    = errors.New(1148, "error parsing APIMANAGER_FILTER filter in configuration. Unrecognized expression")
	...
	ErrFilterSelectorType  = errors.New(1151, "error parsing APIMANAGER_FILTER filter in configuration. Invalid selector type")
