...
// TraceabilityAgentSpecConfigRedactionResponseHeaders The allowed and sanitization setup of response headers in transactional data (management.v1.TraceabilityAgent)
