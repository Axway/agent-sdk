...
// ManagementV1alpha1ApiServiceInstance Definition of APIServiceInstance for version v1alpha1 in group management
type ManagementV1alpha1ApiServiceInstance struct {
	...
	// Name of the APIServiceInstance. Name is unique in its Environment scope and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
