...
// ManagementV1alpha1ConsumerInstance Definition of ConsumerInstance for version v1alpha1 in group management
type ManagementV1alpha1ConsumerInstance struct {
	...
	// Name of the ConsumerInstance. Name is unique in its Environment scope and cannot be updated. The characters allowed in names are: digits (0-9), lower case letters (a-z), -, and .
