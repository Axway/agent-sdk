...
const (
	AmplifyJWTAuthRuleScope = "VirtualAPI"

	AmplifyJWTAuthRuleResourceName = "amplifyjwtauthrules"
)
...
func init() {
	apiv1.RegisterGVK(_AmplifyJWTAuthRuleGVK, AmplifyJWTAuthRuleScope, AmplifyJWTAuthRuleResourceName)
}
