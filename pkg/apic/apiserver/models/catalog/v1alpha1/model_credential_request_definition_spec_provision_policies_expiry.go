...
// CredentialRequestDefinitionSpecProvisionPoliciesExpiry Expery properties for Credentials linked to this definition. (catalog.v1alpha1.CredentialRequestDefinition)
