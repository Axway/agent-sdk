...
// ResourceDefinitionVersionSpec  (definitions.v1.ResourceDefinitionVersion)
type ResourceDefinitionVersionSpec struct {
	...
	// Defines the strucure of the spec for this resource version. (definitions.v1.ResourceDefinitionVersion)
