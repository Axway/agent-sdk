...
// Create -
func (c *ResourceHookClient) Create(res *v1alpha1.ResourceHook) (*v1alpha1.ResourceHook, error) {
	ri, err := res.AsInstance()
...
// Update -
func (c *ResourceHookClient) Update(res *v1alpha1.ResourceHook) (*v1alpha1.ResourceHook, error) {
	ri, err := res.AsInstance()
	if err != nil {
		return nil, err
	}
