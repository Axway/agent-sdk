...
type Client struct {
	...
	CreateSubResourceScopedMock                              func(scopeKindPlural, resKindPlural string, rm v1.ResourceMeta, subs map[string]interface{}) error
	CreateSubResourceUnscopedMock                            func(kindPlural string, rm v1.ResourceMeta, subs map[string]interface{}) error
...
func (m *Client) CreateSubResourceScoped(scopeKindPlural, resKindPlural string, rm v1.ResourceMeta, subs map[string]interface{}) error {
	if m.CreateSubResourceScopedMock != nil {
		return m.CreateSubResourceScopedMock(scopeKindPlural, resKindPlural, rm, subs)
	}
	return nil
}

func (m *Client) CreateSubResourceUnscoped(kindPlural string, rm v1.ResourceMeta, subs map[string]interface{}) error {
	if m.CreateSubResourceUnscopedMock != nil {
		return m.CreateSubResourceUnscopedMock(kindPlural, rm, subs)
	}
	return nil
}
