...
type Provisioning interface {
	AccessRequestProvision(accessRequest AccessRequest) (status RequestStatusBuilder, data map[string]interface{})
	AccessRequestDeprovision(accessRequest AccessRequest) (status RequestStatusBuilder)
	CredentialProvision(credentialRequest CredentialRequest) (status RequestStatusBuilder, credentails Credential)
	CredentialDeprovision(credentialRequest CredentialRequest) (status RequestStatusBuilder)
}
