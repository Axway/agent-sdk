...
| central.usageReporting.publishSubscriptionMetric   | CENTRAL_USAGEREPORTING_PUBLISHSUBSCRIPTIONMETRIC   | Enables/disables the sending of subscription metric events to Amplify (default: `false`)                                                                                                                                                                |
...
| publishSubscriptionMetric   | CENTRAL_USAGEREPORTING_PUBLISHSUBSCRIPTIONMETRIC   | `false`                             | Defines if individual Subscription Metrics will be published to Amplify                                                                                         |
