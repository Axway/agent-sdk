...
| central.reportActivityFrequency  | CENTRAL_REPORTACTIVITYFREQUENCY  | The frequency in which the agent published activity to Amplify Central (default: `5m`)                                                                                                                                                                                                                                   |
| central.clientTimeout            | CENTRAL_CLIENTTIMEOUT            | The time interval at which the http client times out making HTTP requests and processing the response (default: `30s`)                                                                                                                                                                                                   |
...
| output.traceability.client_timeout    | TRACEABILITY_CLIENTTIMEOUT    | Number of seconds to wait for responses from Condor (default:`30s`)                                                                                  |
